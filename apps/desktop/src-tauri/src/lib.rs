...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::workflow::inspect_install_dashboard_command,
            commands::workflow::inspect_stage1_dashboard_command,
            commands::workflow::inspect_version_catalog_command,
            commands::workflow::start_openclaw_install,
            commands::workflow::start_stage1_install,
            commands::workflow::read_install_log_tail_command,
            ...
            commands::post_install::setup_openclaw_qqbot_channel,
            commands::post_install::start_qqbot_login_qr_command,
            commands::post_install::wait_for_qqbot_login_qr_command,
            commands::post_install::set_qqbot_channel_enabled_command,
