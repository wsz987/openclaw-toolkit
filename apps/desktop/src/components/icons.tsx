...
export const AlertIcon = ({ size = 16, className, ...props }: IconProps) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
...
export const FolderIcon = ({ size = 16, className, ...props }: IconProps) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
...
export const SpinnerIcon = ({ size = 16, className, ...props }: IconProps) => (
  ...
  >
    ...
    <line x1="6.83" y1="17.17" x2="9.66" y2="14.34" />
    <line x1="14.34" y1="9.66" x2="17.17" y2="6.83" />
  </svg>
);

export const MonitorIcon = ({ size = 16, className, ...props }: IconProps) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
